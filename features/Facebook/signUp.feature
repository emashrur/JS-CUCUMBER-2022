...
Feature: Sign Up
    ...
    Scenario: Verify current date is displayed on Sign-Up form
        Then I verify current date is displayed in birthday drop downs 
